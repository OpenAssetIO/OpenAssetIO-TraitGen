...
def structure_all_log_messages():
    return [
        ...
        (logging.INFO, "  - AllProperties (v1)"),
        (logging.INFO, "  - Deprecated (v1)"),
        (logging.INFO, "  - MultipleVersions (v1)"),
        (logging.INFO, "  - MultipleVersions (v2)"),
        (logging.INFO, "  - NoProperties (v1)"),
        (logging.INFO, "  - NoPropertiesMultipleUsage (v1)"),
        (logging.INFO, "anotherNamespace:"),
        (logging.INFO, "  - NoProperties (v1)"),
        (logging.INFO, "Specifications:"),
        (logging.INFO, "test:"),
        (logging.INFO, "  - Deprecated (v1)"),
        (logging.INFO, "  - LocalAndExternalTrait (v1)"),
        (logging.INFO, "  - MultipleVersionsOfTrait (v1)"),
        (logging.INFO, "  - MultipleVersionsOfTrait (v2)"),
        (logging.INFO, "  - OneExternalTrait (v1)"),
        (logging.INFO, "  - TwoLocalTraits (v1)"),
    ]
